...
export const EVENTS = [
  ...
  'automodTrigger', 'backupCreated', 'archiveCreated', 'verificationPassed', 'pollEnd', 'reminder', 'inviteJoin', 'birthday', 'achievement', 'tribunalEnd', 'memberJailed', 'memberQuarantined', 'custom',
];
